...
app.post('/apskaita/:id', (req, res) => {
	...
	const gerimai35 = req.body.gerimai35;
	...
	connection.query(
		'INSERT INTO heroku_c2c7cbf8250f549.logs (minksti, kabinami, kabinamivnt, serbetas, stiklines02, stiklines03, stiklines04, vafliutesla, kava, gerimai1, gerimai15, gerimai2, gerimai21, gerimai35, fasuoti1, fasuoti12, fasuoti15, fasuoti17, fasuoti2, fasuoti25, pavadinimas, data) VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?));',
		[pilstomiLedai, kabinamiLedai, kabinamiLedaiVnt, serbetas, stiklines02, stiklines03, stiklines05, vafliuTesla, kava, gerimai, gerimai15, gerimai2, gerimai21, gerimai35, fasuoti1, fasuoti12, fasuoti15, fasuoti17, fasuoti2, fasuoti25, pavadinimas, data],
		function(error, result) {
			if (error) throw error;
	});
	res.redirect('back');
...
app.post('/nuemimas/:id', (req,res) => {
	...
	const gerimai35 = req.body.nuimtaGerimai35;
	...
	const id = req.params.id;
	connection.query(
		'INSERT INTO heroku_c2c7cbf8250f549.nuimta (nuimtaMinksti, nuimtaKabinamiledaivnt, nuimtaKabinami, nuimtaSerbetas, nuimtaStiklines02, nuimtaStiklines03, nuimtaStiklines05, nuimtaKava, nuimtaVafliutesla, nuimtaGerimai1, nuimtaGerimai15, nuimtaGerimai2, nuimtaGerimai21, nuimtaGerimai35, nuimtaFasuoti1, nuimtaFasuoti12, nuimtaFasuoti15, nuimtaFasuoti17, nuimtaFasuoti2, nuimtaFasuoti25, pavadinimas, data) VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?));',
		[pilstomiLedai, kabinamiLedaiVnt, kabinamiLedai, serbetas, stiklines02, stiklines03, stiklines05, kava, vafliuTesla, gerimai1, gerimai15, gerimai2, gerimai21, gerimai35, fasuoti1, fasuoti12, fasuoti15, fasuoti17, fasuoti2, fasuoti25, pavadinimas, data],
		function(error, result) {
			if (error) throw error;
		});
	connection.query(
		'insert into heroku_c2c7cbf8250f549.nuimta_pradzia (nuimta_pradziaMinksti, nuimta_pradziaKabinamiledaivnt, nuimta_pradziaKabinami, nuimta_pradziaSerbetas, nuimta_pradziaStiklines02, nuimta_pradziaStiklines03, nuimta_pradziaStiklines05, nuimta_pradziaKava, nuimta_pradziaVafliutesla, nuimta_pradziaGerimai1, nuimta_pradziaGerimai15, nuimta_pradziaGerimai2, nuimta_pradziaGerimai21, nuimta_pradziaGerimai35, nuimta_pradziaFasuoti1, nuimta_pradziaFasuoti12, nuimta_pradziaFasuoti15, nuimta_pradziaFasuoti17, nuimta_pradziaFasuoti2, nuimta_pradziaFasuoti25, pavadinimas) select atveztaMinksti, atveztaKabinamiledaivnt, atveztaKabinami, atveztaSerbetas, atveztaStiklines02, atveztaStiklines03, atveztaStiklines05, atveztaKava, atveztaVafliutesla, atveztaGerimai1, atveztaGerimai15, atveztaGerimai2, atveztaGerimai21, atveztaGerimai35, atveztaFasuoti1, atveztaFasuoti12, atveztaFasuoti15, atveztaFasuoti17, atveztaFasuoti2, atveztaFasuoti25, pavadinimas from heroku_c2c7cbf8250f549.atvezta where heroku_c2c7cbf8250f549.atvezta.tasko_ID = (?)',
		[id], function(error, result) {
			if (error) throw error;
			console.log(result);
		});
	connection.query('UPDATE `heroku_c2c7cbf8250f549`.`atvezta` SET atveztaMinksti = (?), atveztaKabinami = (?), atveztaKabinamiledaivnt = (?), atveztaSerbetas = (?), atveztaStiklines02 = (?), atveztaStiklines03 = (?), atveztaStiklines05 = (?), atveztaKava = (?), atveztaVafliutesla = (?), atveztaGerimai1 = (?), atveztaGerimai15 = (?), atveztaGerimai2 = (?), atveztaGerimai21 = (?), atveztaGerimai35 = (?), atveztaFasuoti1 = (?), atveztaFasuoti12 = (?), atveztaFasuoti15 = (?), atveztaFasuoti17 = (?), atveztaFasuoti2 = (?), atveztaFasuoti25 = (?) WHERE tasko_ID = (?)',
		[pilstomiLedai, kabinamiLedai, kabinamiLedaiVnt, serbetas, stiklines02, stiklines03, stiklines05, kava, vafliuTesla, gerimai1, gerimai15, gerimai2, gerimai21, gerimai35, fasuoti1, fasuoti12, fasuoti15, fasuoti17, fasuoti2, fasuoti25, id], function(error, result) {
		if (error) throw error;
		console.log(result);
	});
	res.redirect('back');
